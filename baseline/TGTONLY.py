...
def linear_regression(train, dev, test, iter = ITER):
    ...
    for i in range(1,iter + 1):
        ...
        for j in range(0, len(dev)):
            ...
            out = ('Logistic Regression', alpha, mse, i)
    ...
    out = ('Logistic Regression',{'alpha':round(best_alpha,3)}, mse)
...
def main():
    ...
    summary['algorithm'] = 'TGTONLY_' + str(SAMPLES)
    summary.to_csv('summary_TGTONLY_' + str(SAMPLES) + '.csv', index=False, sep = ',')
